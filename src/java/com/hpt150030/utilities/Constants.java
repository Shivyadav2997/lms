...
public class Constants {
    ...
    public static final String NEW_BOOK_REQ_TITLE = "title";
    public static final String NEW_BOOK_REQ_AUTHOR = "author";
    public static final String NEW_BOOK_REQ_ID = "bookId";
    
    public static final String NEW_BRANCH_REQ_NAME = "name";
    public static final String NEW_BRANCH_REQ_ADDRESS = "address";
    public static final String NEW_BRANCH_REQ_ID = "branchId";
    
    public static final String NEW_CBOOK_REQ_ID = "bookId";
    public static final String NEW_CBRANCH_REQ_ID = "branchId";
    public static final String NEW_BRANCH_REQ_COPIES = "branchCopy";
